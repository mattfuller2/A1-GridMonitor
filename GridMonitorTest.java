...
public class GridMonitorTest {
	...
	private boolean getBaseGridSampleTest() {
		final double[][] expected = { { 2, 10, 7 }, { 4, 5, 8 }, { 5, 6, 9 } };
		final String testFile = "sample.txt";
		boolean success = true;
	...
	private boolean getSurroundingSumGridSampleTest() {
		final double[][] expected = { { 18, 24, 32 }, { 16, 28, 29 }, { 20, 25, 32 } };
		final String testFile = "sample.txt";
		boolean success = true;
	...
	private boolean getSurroundingAvgGridSampleTest() {
		final double[][] expected = { { 4.5, 6.0, 8.0 }, { 4.0, 7.0, 7.25 }, { 5.0, 6.25, 8.0 } };
		final String testFile = "sample.txt";
		boolean success = true;
	...
	private boolean getDeltaGridSampleTest() {
		final double[][] expected = { { 2.25, 3.0, 4.0 }, { 2.0, 3.5, 3.625 }, { 2.5, 3.125, 4.0 } };
		final String testFile = "sample.txt";
		boolean success = true;
	...
	private boolean getDangerGridSampleTest() {
		final boolean[][] expected = { { true, true, false }, { false, false, false }, { false, false, false } };
		final String testFile = "sample.txt";
		boolean success = true;
	...
	/**
	 * Exercise toString() after loading "sample.txt" testing toString() is a little
	 * challenging because unit tests should be automated such that no user
	 * evaluation is necessary to determine if a test has succeeded or failed - need
	 * to compare toString() output to expected output
	 */
	...
	/**
	 * get sum grid, make a change via returned reference, confirm original is
	 * unchanged
	 */
	...
	/**
	 * get avg grid, make a change via returned reference, confirm original is
	 * unchanged
	 */
	...
	/**
	 * get danger grid, make a change via returned reference, confirm original is
	 * unchanged
	 */
	...
	private boolean getBaseGrid4x5Test() {
		final double[][] expected = { { 1, 3, 7, 6, 5 }, { 4, 10, 8, 7, 4 }, { 5, 5, 7, 8, 7 }, { 3, 6, 8, 9, 6 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getSurroundingSumGrid4x5Test() {
		final double[][] expected = { { 9, 21, 24, 25, 20 }, { 20, 20, 31, 26, 23 }, { 17, 28, 29, 30, 25 }, { 17, 22, 30, 31, 28 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getSurroundingAvgGrid4x5Test() {
		final double[][] expected = { { 2.25, 5.25, 6.0, 6.25, 5.0 }, { 5.0, 5.0, 7.75, 6.5, 5.75 }, { 4.25, 7.0, 7.25, 7.5, 6.25 }, { 4.25, 5.5, 7.5, 7.75, 7.0 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getDeltaGrid4x5Test() {
		final double[][] expected = { { 1.125, 2.625, 3.0, 3.125, 2.5 }, { 2.5, 2.5, 3.875, 3.25, 2.875 }, { 2.125, 3.5, 3.625, 3.75, 3.125 }, { 2.125, 2.75, 3.75, 3.875, 3.5 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getDangerGrid4x5Test() {
		final boolean[][] expected = { { true, false, false, false, false }, { false, true, false, false, false }, { false, false, false, false, false }, { false, false, false, false, false } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getBaseGridDoublesTest() {
		final double[][] expected = { { 2.5, 10.5, 7.5 }, { 4.5, 5.5, 8.5 }, { 5.5, 6.5, 9.5 } };
		final String testFile = "sampleDoubles.txt";
		boolean success = true;
	...
	private boolean getSurroundingSumGridDoublesTest() {
		final double[][] expected = { { 20, 26, 34 }, { 18, 30, 31 }, { 22, 27, 34 } };
		final String testFile = "sampleDoubles.txt";
		boolean success = true;
	...
	private boolean getBaseGridNegativesTest() {
		final double[][] expected = { { -5, -4, -5 }, { -2, -1, -2 }, { -1, -3, -1 } };
		final String testFile = "negatives.txt";
		boolean success = true;
	...
	private boolean getSurroundingSumGridNegativesTest() {
		final double[][] expected = { { -16, -15, -16 }, { -9, -11, -9 }, { -7, -6, -7 } };
		final String testFile = "negatives.txt";
		boolean success = true;
	...
	private boolean getSurroundingAvgGridNegativesTest() {
		final double[][] expected = { { -4.0, -3.75, -4.0 }, { -2.25, -2.75, -2.25 }, { -1.75, -1.5, -1.75 } };
		final String testFile = "negatives.txt";
		boolean success = true;
	...
	private boolean getDeltaGridNegativesTest() {
		final double[][] expected = { { 2.0, 1.875, 2.0 }, { 1.125, 1.375, 1.125 }, { 0.875, 0.75, 0.875 } };
		final String testFile = "negatives.txt";
		boolean success = true;
	...
	private boolean getDangerGridNegativesTest() {
		final boolean[][] expected = { { false, false, false }, { false, true, false }, { false, true, false } };
		final String testFile = "negatives.txt";
		boolean success = true;
	...
	/**
	 * Compare result from getSurroundingMaxGrid() to expected grid for
	 * "oneByOne.txt"
	 */
	...
	private boolean getBaseGridWideRangeTest() {
		final double[][] expected = { { 0, 0, 0 }, { -2000000000, 10, 2000000000 }, { 0, 0, 0 } };
		final String testFile = "wideRange.txt";
		boolean success = true;
	...
	/**
	 * Confirm that FileNotFoundException is thrown when GridMonitor constructor is
	 * called with "noSuch.txt"
	 */
	@SuppressWarnings("unused")
	 ...
	 * @param a2
	 *            second double[][]
	 * @return true if all values in a1 and a2 are within the given tolerance, else
	 *         false
	 */
